...
public static class G25AdmixtureEraEndpoints
{
    public static void MapG25AdmixtureEraEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        endpoints.MapGet("/", GetAll)
            ...
            .Produces<IReadOnlyList<GetG25AdmixtureEraContract.Response>>(StatusCodes.Status200OK);

        endpoints.MapGet("/{id:int}", GetById)
            .RequireAuthorization("EmailVerified")
            .RequireRateLimiting("authenticated")
            .Produces<GetG25AdmixtureEraContract.Response>(StatusCodes.Status200OK);

        endpoints.MapPost("/", Create)
            .RequireAuthorization("AdminOnly")
            .RequireRateLimiting("strict")
            .Produces<GetG25AdmixtureEraContract.Response>(StatusCodes.Status201Created);
