namespace Odin.Api.Endpoints.G25PcaPopulationsSampleManagement.Models;
...
public static class GetG25PcaPopulationsSampleContract
{
    public class Response
    {
        public int Id { get; set; }
...
public static class CreateG25PcaPopulationsSampleContract
{
...
public static class UpdateG25PcaPopulationsSampleContract
{
    public class Request
    {
        public required string Label { get; set; }
