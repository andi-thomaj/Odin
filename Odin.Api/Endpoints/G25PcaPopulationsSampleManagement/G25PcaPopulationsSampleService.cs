...
public interface IG25PcaPopulationsSampleService
{
    Task<IReadOnlyList<GetG25PcaPopulationsSampleContract.Response>> GetAllAsync(CancellationToken cancellationToken = default);
    Task<GetG25PcaPopulationsSampleContract.PagedResponse> GetPagedAsync(int page, int pageSize, CancellationToken cancellationToken = default);
    Task<GetG25PcaPopulationsSampleContract.Response?> GetByIdAsync(int id, CancellationToken cancellationToken = default);
    Task<CreateG25PcaPopulationsSampleContract.Response> CreateAsync(string identityId, CreateG25PcaPopulationsSampleContract.Request request,
        CancellationToken cancellationToken = default);
    Task<GetG25PcaPopulationsSampleContract.Response?> UpdateAsync(int id, string identityId, UpdateG25PcaPopulationsSampleContract.Request request,
        CancellationToken cancellationToken = default);
...
public class G25PcaPopulationsSampleService(ApplicationDbContext dbContext) : IG25PcaPopulationsSampleService
{
    ...
    {
        return await dbContext.G25PcaPopulationsSamples
            .AsNoTracking()
            .OrderBy(e => e.Id)
            .Select(e => new GetG25PcaPopulationsSampleContract.Response
            {
                Id = e.Id,
                Label = e.Label,
    ...
    public async Task<GetG25PcaPopulationsSampleContract.PagedResponse> GetPagedAsync(int page, int pageSize,
        CancellationToken cancellationToken = default)
    {
        if (page < 1) page = 1;
        ...
        var query = dbContext.G25PcaPopulationsSamples.AsNoTracking();
        ...
        return new GetG25PcaPopulationsSampleContract.PagedResponse
        {
            Items = items,
    ...
    public async Task<GetG25PcaPopulationsSampleContract.Response?> GetByIdAsync(int id, CancellationToken cancellationToken = default)
    {
        return await dbContext.G25PcaPopulationsSamples
            .AsNoTracking()
            .Where(e => e.Id == id)
    ...
    public async Task<CreateG25PcaPopulationsSampleContract.Response> CreateAsync(string identityId, CreateG25PcaPopulationsSampleContract.Request request,
        CancellationToken cancellationToken = default)
    {
        ...
        var entity = new G25PcaPopulationsSample
        {
    ...
    public async Task<GetG25PcaPopulationsSampleContract.Response?> UpdateAsync(int id, string identityId, UpdateG25PcaPopulationsSampleContract.Request request,
        CancellationToken cancellationToken = default)
    {
        var entity = await dbContext.G25PcaPopulationsSamples
