...
public static class G25RegionEndpoints
{
    public static void MapG25RegionEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        endpoints.MapGet("/", GetAll)
            ...
            .Produces<IReadOnlyList<GetG25RegionContract.Response>>(StatusCodes.Status200OK);

        endpoints.MapGet("/{id:int}", GetById)
            .RequireAuthorization("EmailVerified")
            .RequireRateLimiting("authenticated")
            .Produces<GetG25RegionContract.Response>(StatusCodes.Status200OK);
        ...
        endpoints.MapPost("/", Create)
            ...
            .Produces<GetG25RegionContract.Response>(StatusCodes.Status201Created);
