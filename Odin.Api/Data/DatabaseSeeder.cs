...
public class DatabaseSeeder(ApplicationDbContext context)
{
    ...
    public async Task SeedReferenceCatalogAsync()
    {
        ...
        await BackfillPopulationMediaAsync();
            ...
            new
            {
                ...
                Populations = new (string Name, string Description, string? IconFileName, string? VideoFileName)[]
                {
                    ("Anatolian Neolithic Farmer",
                        ...
                        "anatolian-neolithic-farmer.svg", null),
                    ("Western Steppe Herder",
                        ...
                        "western-steppe-herder.svg", null),
                    ("Western Hunter Gatherer",
                        ...
                        "western-hunter-gatherer.svg", null),
                    ("Caucasian Hunter Gatherer",
                        ...
                        "caucasian-hunter-gatherer.svg", null),
                    ("Iranian Neolithic Farmer",
                        ...
                        "iranian-neolithic-farmer.svg", null),
                    ("Natufian",
                    ...
                    ("Northeast Asian",
                        ...
                        "northeast-asian-neolithic.svg", null),
                    ("Native American",
                    ...
                    ("Ancestral South Indian",
                        ...
                        "ancient-ancestral-south-indian.svg", null),
            ...
            new
            {
                ...
                Populations = new (string Name, string Description, string? IconFileName, string? VideoFileName)[]
                {
                    ...
                    ("Roman East Mediterranean",
                        ...
                        "roman-east-mediterranean.svg", null),
                    ("Germanic",
    ...
    private async Task BackfillPopulationMediaAsync()
    {
        var mediaMap = new Dictionary<string, (string? Icon, string? Video)>
        {
            ["Anatolian Neolithic Farmer"] = ("anatolian-neolithic-farmer.svg", null),
            ["Western Steppe Herder"] = ("western-steppe-herder.svg", null),
            ["Western Hunter Gatherer"] = ("western-hunter-gatherer.svg", null),
            ["Caucasian Hunter Gatherer"] = ("caucasian-hunter-gatherer.svg", null),
            ["Iranian Neolithic Farmer"] = ("iranian-neolithic-farmer.svg", null),
            ["Natufian"] = ("natufian.svg", null),
            ["North African Farmer"] = ("north-african-farmer.svg", null),
            ["Northeast Asian"] = ("northeast-asian-neolithic.svg", null),
            ["Native American"] = ("native-american.svg", null),
            ["Ancestral South Indian"] = ("ancient-ancestral-south-indian.svg", null),
            ["Sub Saharan Africans"] = ("sub-saharan-african.svg", null),
            ["Finno-Ugric"] = ("uralic.svg", null),
            ["Illyrian"] = ("illyrian.svg", null),
            ["Ancient Greek"] = ("ancient-greek.svg", "Ancient Greek.mp4"),
            ["Thracian"] = ("thracian.svg", null),
            ["Hittite & Phrygian"] = ("hittite-phrygian.svg", null),
            ["Phoenician"] = ("phoenician.svg", null),
            ["Celtic"] = ("insular-celt.svg", null),
            ["Iberian"] = ("iberian.svg", null),
            ["Punic Carthage"] = ("punic-carthage.svg", null),
            ["Hellenistic Pontus"] = ("hellenistic-pontus.svg", null),
            ["Latin and Etruscan"] = ("italic-and-etruscan.svg", null),
            ["Roman Moesia Superior"] = ("roman-moesia.svg", null),
            ["Medieval Albanian"] = ("proto-albanian.svg", null),
            ["Roman East Mediterranean"] = ("roman-east-mediterranean.svg", null),
            ["Germanic"] = ("germanic.svg", null),
            ["Medieval Slavic"] = ("medieval-slav.svg", null),
            ["Roman North Africa"] = ("berber.svg", null),
        };

        var populations = await context.Populations
            .Where(p => p.IconFileName == null || p.VideoFileName == null)
            .ToListAsync();

        var changed = false;
        foreach (var pop in populations)
        {
            if (!mediaMap.TryGetValue(pop.Name, out var media))
                continue;

            if (pop.IconFileName == null && media.Icon != null)
            {
                pop.IconFileName = media.Icon;
                changed = true;
            }
            if (pop.VideoFileName == null && media.Video != null)
            {
                pop.VideoFileName = media.Video;
                changed = true;
            }
        }
