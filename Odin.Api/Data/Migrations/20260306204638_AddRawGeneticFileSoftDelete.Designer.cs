...
namespace Odin.Api.Data.Migrations
{
    ...
    [Migration("20260306204638_AddRawGeneticFileSoftDelete")]
    partial class AddRawGeneticFileSoftDelete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PopulationQpadmResult", b =>
                {
                    b.Property<int>("PopulationsId")
                        .HasColumnType("integer");

                    b.Property<int>("QpadmResultId")
                        .HasColumnType("integer");

                    b.HasKey("PopulationsId", "QpadmResultId");
            ...
            modelBuilder.Entity("Odin.Api.Data.Entities.GeneticInspection", b =>
                {
                    ...
                    b.HasOne("Odin.Api.Data.Entities.RawGeneticFile", "RawGeneticFile")
                        .WithOne("GeneticInspection")
                        .HasForeignKey("Odin.Api.Data.Entities.GeneticInspection", "RawGeneticFileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PopulationQpadmResult", b =>
                {
                    b.HasOne("Odin.Api.Data.Entities.Population", null)
                        .WithMany()
                        .HasForeignKey("PopulationsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Odin.Api.Data.Entities.QpadmResult", null)
                        .WithMany()
                        .HasForeignKey("QpadmResultId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
